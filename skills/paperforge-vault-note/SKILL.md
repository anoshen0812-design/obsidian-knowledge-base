...
3. Read the complete page-delimited extract. Inspect the source PDF when figures, tables, formulas, or extraction ambiguities affect a claim.
...
6. Attach a PDF page link to every substantive claim about the paper. Mark uncertain pages for review; never infer page numbers from nearby text.
